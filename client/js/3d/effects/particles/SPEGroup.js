...
SPEGroup.constructor = SPEGroup;


SPEGroup.prototype._updateDefines = function() {
    'use strict';
...
SPEGroup.prototype._applyAttributesToGeometry = function() {
    'use strict';
 ...
 */
SPEGroup.prototype.addEmitter = function( emitter ) {
    'use strict';
 ...
 * @param {Emitter} emitter The emitter to add to this group.
 */
SPEGroup.prototype.removeEmitter = function( emitter ) {
    'use strict';
 ...
 * @return {Emitter|null}
 */
SPEGroup.prototype.getFromPool = function() {
    'use strict';
 ...
 */
SPEGroup.prototype.releaseIntoPool = function( emitter ) {
    'use strict';
 ...
 * @return {Array}
 */
SPEGroup.prototype.getPool = function() {
    'use strict';
    return this._pool;
};
 ...
 * @return {Group} This group instance.
 */
SPEGroup.prototype.addPool = function( numEmitters, emitterOptions, createNew ) {
    'use strict';
...
SPEGroup.prototype._triggerSingleEmitter = function( pos ) {
    'use strict';
 ...
 * @return {Group} This group instance.
 */
SPEGroup.prototype.triggerPoolEmitter = function( numEmitters, position ) {
    'use strict';
...
SPEGroup.prototype._updateUniforms = function( dt ) {
    'use strict';
...
SPEGroup.prototype._resetBufferRanges = function() {
    'use strict';
...
SPEGroup.prototype._updateBuffers = function( emitter ) {
    'use strict';
 ...
 */
SPEGroup.prototype.tick = function( dt ) {
    'use strict';
 ...
 */
SPEGroup.prototype.dispose = function() {
    'use strict';
